export default {
  plugs: [
    ...
    {
      id: "Weapon_Bonus_CritChance_OneHand_T1",
      changes: [
        {
    ...
    {
      id: "Weapon_Bonus_CritChance_OneHand_T2",
      changes: [
        {
          id: "system.bonuses.crit_chance",
          mode: "Add",
    ...
    {
      id: "Weapon_Bonus_CritChance_OneHand_T3",
      changes: [
        {
          id: "system.bonuses.crit_chance",
          mode: "Add",
    ...
    {
      id: "Weapon_Bonus_CritChance_OneHand_T4",
      changes: [
        {
          id: "system.bonuses.crit_chance",
          mode: "Add",
    ...
    {
      id: "Weapon_Bonus_CritChance_TwoHand_T1",
      changes: [
        {
          id: "system.bonuses.crit_chance",
          mode: "Add",
    ...
    {
      id: "Weapon_Bonus_CritChance_TwoHand_T2",
      changes: [
        {
          id: "system.bonuses.crit_chance",
          mode: "Add",
    ...
    {
      id: "Weapon_Bonus_CritChance_TwoHand_T3",
      changes: [
        {
          id: "system.bonuses.crit_chance",
          mode: "Add",
    ...
    {
      id: "Armor_StatusApply_Suffocating",
      changes: [
        {
