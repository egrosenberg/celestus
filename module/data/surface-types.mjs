...
export const surfaceTypes = {
  ...
  fire: {
    ...
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements/Elements_01-512x512-25.webp",
  },
  spiritfire: {
    label: "Spirit Fire",
    color: "#00ffff",
    ...
    arrowheads: { name: "Flaming Arrowheads", damage: "fire" },
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Spiritfire-2-25.webp",
  },
  water: {
    label: "Water",
    color: "#3333cc",
    ...
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements/Elements_20-512x512-25.webp",
  },
  ice: {
    label: "Ice",
    color: "#99ccff",
    ...
    arrowheads: { name: "Frozen Arrowheads", damage: "water" },
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Ice-25.webp",
  },
  electric_water: {
    ...
    arrowheads: { name: "Frozen Arrowheads", damage: "water" },
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Lightning-water-25-100.webp",
  },
  oil: {
    label: "Oil",
    color: "#d28f79",
    ...
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Oil-mud-50.webp",
  },
  poison: {
    label: "Poison",
    color: "#33cc33",
    ...
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Poison-25.webp",
  },
  frozen_poison: {
    label: "Frozen Poison",
    color: "#33cc33",
    ...
    arrowheads: { name: "Toxic Arrowheads", damage: "poison" },
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Frozen-poison-25.webp",
  },
  blood: {
    label: "Blood",
    color: "#cc0000",
    ...
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Blood-3-25.webp",
  },
  electric_blood: {
    ...
    arrowheads: { name: "Bloodied Arrowheads", damage: "piercing" },
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Lightning-blood-25-100.webp",
  },
  frozen_blood: {
    label: "Frozen Blood",
    color: "#cc0000",
    ...
    arrowheads: { name: "Bloodied Arrowheads", damage: "piercing" },
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Frozen-blood-25.webp",
  },
  fog: {
    label: "Fog",
    color: "#cccccc",
    ...
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Fog-2-50.webp",
  },
  electric_fog: {
    label: "Electric Fog",
    color: "#cccccc",
    ...
    texture:
      "systems/celestus/assets/CC/Screaming%20Brain%20Studios/Elements-Modified/Lightning-cloud-2-50.webp",
  },
};
